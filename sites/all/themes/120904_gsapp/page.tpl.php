...
<head>
	...
	<?php if($mobile_iscroll === TRUE){ ?>
		<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/iscroll.js"></script>
	<?php } ?>
	...
	<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/jquery.scrollTo-1.4.2-min.js"></script>
		...
		<?php if($is_mobile === TRUE) { /* mobile theme */?>
			<div id="header">
				...
				<a id="gsapp-news" href="http://news.gsapp.org">
					<img src="<?php print $includes_dir; ?>/tmpltzr/assets/mobile/gsapp_news_83x81.jpg" width="83" height="81" alt="GSAPP News" />
				</a>
