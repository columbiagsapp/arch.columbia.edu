...
<head>
	...
	<?php print $styles; ?>
	<?php if($is_mobile === TRUE){ ?>
		<link type="text/css" rel="stylesheet" media="all" href="<?php print $includes_dir; ?>/tmpltzr/css/mobile.css">
	<?php }else{ ?>
	...
	<?php if($mobile_iscroll === TRUE){ ?>
		<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/iscroll.js?<?php print rand(10000,99999); ?>"></script>
	<?php } 
	 if($is_mobile===FALSE){?>
		<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/jquery.jscrollpane.min.js"></script>
		<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/jquery.mousewheel.js"></script>
		<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/jquery.masonry.min.js"></script>
	<?php } ?>
	<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/jcarousellite_1.0.1.min.js"></script>
	<script src="<?php print $includes_dir; ?>/tmpltzr/js/html4+html5/jquery.history.js"></script>
	<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/fetcher.js?<?php print rand(10000,99999); ?>"></script>
	<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/gsapp.js?<?php print rand(10000,99999); ?>"></script>
	<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/ajaxify-html5.js?<?php print rand(10000,99999); ?>"></script>

	<?php if($is_mobile === TRUE){ ?>
	<script type="text/javascript" src="<?php print $includes_dir; ?>/tmpltzr/js/jquery.touchSwipe.min.js"></script>
	<?php } ?>
	...
	<!-- Google Analytics, no longer using module, it throws an error -->
	<script type="text/javascript">
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-7430737-4']);
		...
		<?php if($is_mobile === TRUE) { /* mobile theme */?>
			<div id="header">
				<a id="gsapp-logo" href="/">
					<img src="<?php print $includes_dir; ?>/tmpltzr/assets/mobile/gsapp-logo_237x49.jpg" width="237" height="49" alt="GSAPP logo" />
				</a>
				<a id="gsapp-mobile-search" href="/" target="_self">
					<img src="<?php print $includes_dir; ?>/tmpltzr/assets/mobile/search_56x54.jpg" width="56" height="54" alt="Search" />
				</a>
			...
			<div id="navigation">
				<div id="menu">
					...
					<div id="menufooter">
						<img id="gradArchLogo" src="<?php print $includes_dir; ?>/tmpltzr/assets/gradArch_full.png" />
						<a href="http://www.columbia.edu" target="_blank">
							<img id="CUlogo" src="<?php print $includes_dir; ?>/tmpltzr/assets/CUlogo_460_efefef.png" width="190" />
						</a>
					</div>
				</div>
				<div id="menuswitch"><img src="<?php print $includes_dir; ?>/tmpltzr/assets/viewmenu.png"/></div>
			</div>
			...
			<div id="wrapper">
				...
				<div id="contentswitch"><img src="<?php print $includes_dir; ?>/tmpltzr/assets/viewpage.png"/></div>
			</div>

		<?php }else{ /* tablet using iscroll and non-mobile */?>
			<header id="header">
				<a href="<?php print base_path(); ?>" title="<?php print t('Home'); ?>" id="gsapplogo">
					<img src="<?php print $includes_dir; ?>/tmpltzr/assets/gsapp_logo.png" alt="<?php print t('Home'); ?>" />
				</a>		
			...
			<a href="http://www.columbia.edu" title="<?php print t('Columbia University'); ?>" target="_blank" id="columbialogo">
					<img src="<?php print $includes_dir; ?>/tmpltzr/assets/columbia_logo.png" alt="<?php print t('Columbia University'); ?>" />
			</a>	
			<!-- #content -->
